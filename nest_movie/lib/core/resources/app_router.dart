...
import 'package:nest_movie/core/presentation/pages/main_page.dart';
import 'package:nest_movie/movies/presentation/views/movie_details_view.dart';
import 'package:nest_movie/movies/presentation/views/movies_view.dart';
import 'package:nest_movie/movies/presentation/views/popular_movies_view.dart';
import 'package:nest_movie/movies/presentation/views/top_rated_movies_view.dart';
import 'package:nest_movie/search/presentation/views/search_view.dart';
import 'package:nest_movie/tv_shows/presentation/views/popular_tv_shows_view.dart';
import 'package:nest_movie/tv_shows/presentation/views/top_rated_tv_shows_view.dart';
import 'package:nest_movie/tv_shows/presentation/views/tv_show_details_view.dart';
import 'package:nest_movie/tv_shows/presentation/views/tv_shows_view.dart';

import 'package:nest_movie/core/resources/app_routes.dart';
import 'package:nest_movie/watchlist/presentation/views/watchlist_view.dart';
